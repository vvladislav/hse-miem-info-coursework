...
cpp: $(SRC-DIR-GAME)Map.cpp $(SRC-DIR-GAME)Place.cpp $(SRC-DIR-GAME)Player.cpp $(SRC-DIR-OBJECTS)AttackingObject.cpp $(SRC-DIR-OBJECTS)Building.cpp $(SRC-DIR-OBJECTS)DestroyingObject.cpp $(SRC-DIR-OBJECTS)MovingObject.cpp $(SRC-DIR-OBJECTS)ResourceObject.cpp $(SRC-DIR-OBJECTS)SimpleObject.cpp $(SRC-DIR-OBJECTS)Terrain.cpp $(SRC-DIR-OBJECTS)Unit.cpp $(SRC-DIR)main.cpp 
	$(CXX) $(CXXFLAGS) $(CXXHEADERSFLAGS) src/ $(CXXHEADERSFLAGS) src/game_process/ $(CXXHEADERSFLAGS) src/objects/ $(SRC-DIR-GAME)Map.cpp $(SRC-DIR-GAME)Place.cpp $(SRC-DIR-GAME)Player.cpp $(SRC-DIR-OBJECTS)AttackingObject.cpp $(SRC-DIR-OBJECTS)Building.cpp $(SRC-DIR-OBJECTS)DestroyingObject.cpp $(SRC-DIR-OBJECTS)MovingObject.cpp $(SRC-DIR-OBJECTS)ResourceObject.cpp $(SRC-DIR-OBJECTS)SimpleObject.cpp $(SRC-DIR-OBJECTS)Terrain.cpp $(SRC-DIR-OBJECTS)Unit.cpp $(SRC-DIR)main.cpp  -o $(BIN-DIR)main.out 
