...
# Template: app
# Command: /usr/bin/qmake -o Makefile strategy.pro -spec linux-g++
#############################################################################
...
INCPATH       = -I. -Isrc -Isrc/game_process -Isrc/objects -I. -isystem /usr/include/qt -isystem /usr/include/qt/QtWidgets -isystem /usr/include/qt/QtGui -isystem /usr/include/qt/QtCore -I. -isystem /usr/include/libdrm -I/usr/lib/qt/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
DISTDIR = /home/vlad/MIEM/InfCourse/strategy/.swp/strategy.out1.0.0
LINK          = g++
...
OBJECTS       = .swp/main.o \
		...
		.swp/Place.o \
		.swp/Player.o \
		.swp/AttackingObject.o \
		.swp/Building.o \
		.swp/DestroyableObject.o \
		.swp/MovingObject.o \
		.swp/ResourceObject.o \
		.swp/SimpleObject.o \
		.swp/Terrain.o \
		.swp/Unit.o
...
Makefile: strategy.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile strategy.pro -spec linux-g++
...
.swp/main.o: src/main.cpp src/All-include.h \
		src/game_process/Game.h \
		src/game_process/Player.h \
		src/objects/Unit.h \
		src/objects/MovingObject.h \
		...
		src/objects/AttackingObject.h \
		src/objects/Building.h \
		src/game_process/Game.tpp
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/main.o src/main.cpp

.swp/Map.o: src/game_process/Map.cpp src/All-include.h \
		src/game_process/Map.h \
		src/game_process/Place.h \
		src/objects/Terrain.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/Map.o src/game_process/Map.cpp

.swp/Place.o: src/game_process/Place.cpp src/All-include.h \
		src/game_process/Place.h \
		src/objects/Terrain.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/Place.o src/game_process/Place.cpp

.swp/Player.o: src/game_process/Player.cpp src/All-include.h \
		src/game_process/Player.h \
		src/objects/Unit.h \
		src/objects/MovingObject.h \
		src/objects/SimpleObject.h \
		...
		src/objects/AttackingObject.h \
		src/objects/Building.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/Player.o src/game_process/Player.cpp

.swp/AttackingObject.o: src/objects/AttackingObject.cpp src/All-include.h \
		src/objects/AttackingObject.h \
		src/objects/SimpleObject.h \
		src/game_process/Place.h \
		src/objects/Terrain.h \
		src/game_process/Map.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/AttackingObject.o src/objects/AttackingObject.cpp

.swp/Building.o: src/objects/Building.cpp src/All-include.h \
		src/objects/Building.h \
		src/objects/AttackingObject.h \
		src/objects/SimpleObject.h \
		src/game_process/Place.h \
		...
		src/objects/Unit.h \
		src/objects/MovingObject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/Building.o src/objects/Building.cpp

.swp/DestroyableObject.o: src/objects/DestroyableObject.cpp src/All-include.h \
		src/objects/DestroyableObject.h \
		src/objects/SimpleObject.h \
		src/game_process/Place.h \
		src/objects/Terrain.h \
		src/game_process/Map.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/DestroyableObject.o src/objects/DestroyableObject.cpp

.swp/MovingObject.o: src/objects/MovingObject.cpp src/All-include.h \
		src/objects/MovingObject.h \
		src/objects/SimpleObject.h \
		src/game_process/Place.h \
		src/objects/Terrain.h \
		src/game_process/Map.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/MovingObject.o src/objects/MovingObject.cpp

.swp/ResourceObject.o: src/objects/ResourceObject.cpp src/All-include.h \
		src/objects/ResourceObject.h \
		src/objects/SimpleObject.h \
		src/game_process/Place.h \
		src/objects/Terrain.h \
		src/game_process/Map.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/ResourceObject.o src/objects/ResourceObject.cpp

.swp/SimpleObject.o: src/objects/SimpleObject.cpp src/All-include.h \
		src/objects/SimpleObject.h \
		src/game_process/Place.h \
		src/objects/Terrain.h \
		src/game_process/Map.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/SimpleObject.o src/objects/SimpleObject.cpp

.swp/Terrain.o: src/objects/Terrain.cpp src/All-include.h \
		src/objects/Terrain.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/Terrain.o src/objects/Terrain.cpp

.swp/Unit.o: src/objects/Unit.cpp src/All-include.h \
		src/objects/Unit.h \
		src/objects/MovingObject.h \
		src/objects/SimpleObject.h \
		src/game_process/Place.h \
		...
		src/objects/DestroyableObject.h \
		src/objects/AttackingObject.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .swp/Unit.o src/objects/Unit.cpp
